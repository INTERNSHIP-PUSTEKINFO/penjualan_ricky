              ...
              <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                  <?php 
                      include('../koneksi.php');
                      $no = 1;
                      $isupplier = mysqli_query($connection,"SELECT * FROM supplier");
                      while($row = mysqli_fetch_array($isupplier)){
                  ?>
                  ...
                  <tr>
                      ...
                      <td class="text-center"> 
                        <a href="edit-supplier.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary">LIHAT</a>
